...
import { ShieldAlert, Activity, ActivitySquare, TrendingUp, LayoutDashboard, CheckCircle2 } from 'lucide-react';
...
export default function ExecutiveDashboard() {
  ...
  if (isLoading) {
    return (
      <div className="max-w-7xl mx-auto p-6 lg:p-8 space-y-8 animate-pulse">
        <div className="flex items-center justify-between mb-2">
          <div className="h-8 w-80 bg-slate-800/80 rounded-lg"></div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="col-span-1 md:col-span-3 bg-slate-900 border border-slate-800 rounded-2xl p-8 h-40"></div>
          <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 h-48"></div>
          <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 h-48"></div>
          <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 h-48"></div>
          <div className="col-span-1 md:col-span-2 bg-slate-900 border border-slate-800 rounded-xl p-6 h-64"></div>
          <div className="col-span-1 bg-slate-900 border border-slate-800 rounded-xl p-6 h-64"></div>
        </div>
